 ...
 ****************************************************************/
#include "identitiessortmodel.h"

IdentitiesSortModel::IdentitiesSortModel(QObject *parent)
...
bool IdentitiesSortModel::filterAcceptsRow(int sourceRow,
...
bool IdentitiesSortModel::lessThan(const QModelIndex &left,
...
void IdentitiesSortModel::setSearchText(QString search)
{
	searchText = search;
	invalidateFilter();
}
